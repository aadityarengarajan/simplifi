...
#=============================================================initiation===============================================================================
os.system('title Simplifi - Simplify Life :-)')
def timee(hour):
    return (
...
if timee(hour)=='morning':
    bgimg="https://www.mondanite.net/wp-content/uploads/2019/01/plane.jpg"
elif timee(hour)=='evening':
    bgimg="https://i.redd.it/muxtfj6vxoq21.jpg"
elif timee(hour)=='night':
    bgimg="https://wallpapercave.com/wp/wp3355853.jpg"
cwd=os.getcwd()
...
#         #print(index-1)
#         #print(tdys)
#         popper=tdys.pop(index-1)
#         popper=tdysno.pop(index-1)
#     found=0
#     index=0
...
##                        pass
        ...
        thejobs.append(str(i)+' : '+str(wodi[count]+' - '+str(podi[count])+' days left and '+str(eodi[count])+' days needed\n\n'))
##                try:
##                        print(wodi[count-1])
##                except:
##                        pass
...
<table class="mdl-data-table mdl-js-data-table" align="center" id="view-source" style="background-color:black;color:white;">
<tbody>
<tr>
<td class="mdl-data-table__cell--non-numeric" style="color:grey;">TOOLS</td>
</tr>
<tr>
<td class="mdl-data-table__cell--non-numeric"><a href="#graphdash"><button class="mdl-button mdl-js-button mdl-js-ripple-effect" style="color:grey;">Graph</button></a></td>
</tr>
</tr>
<tr>
<td class="mdl-data-table__cell--non-numeric"><a href="#calendar"><button class="mdl-button mdl-js-button mdl-js-ripple-effect" style="color:grey;">Calendar</button></a></td>
</tr>
</tr>
<tr>
<td class="mdl-data-table__cell--non-numeric"><a href="#timer"><button class="mdl-button mdl-js-button mdl-js-ripple-effect" style="color:grey;">Timer</button></a></td>
</tr>
<tr>
<td class="mdl-data-table__cell--non-numeric"><a href="#"><button class="mdl-button mdl-js-button mdl-js-ripple-effect" style="color:grey;">Dashboard</button></a></td>
</tr>
</tbody>
</table>
<xo id='noprrrrr'>
...
<div class="demo-card-wide-1 mdl-card mdl-shadow--2dp" id="timer" style="width: 85%;">
  <div class="mdl-card__supporting-text">
    <iframe src="'''+str(str("http://ipadstopwatch.com/timer-fullscreen.html"))+'''" style="height: 512px;" /></iframe>
  </div>
  <div class="mdl-card__actions mdl-card--border">
    <a class="mdl-button mdl-button--colored mdl-js-button mdl-js-ripple-effect" href="'''+str(str("http://ipadstopwatch.com/timer-fullscreen.html"))+'''" target="_blank">
      Open in New Tab
    </a>
  </div>
</div>
...
try:
    ...
    <div class="head">
        <div class="headerobjectswrapper">
            <header>TODAY'S TOP NEWS</header>
        </div>

        <div class="subhead">TOP HEADLINES - {datetime.datetime.now().strftime('%d/%m/%Y')}</div>
    </div>
    <div class="content">
        <div class="collumns">
    '''
    ...
    htmllines=[prehtml]
    googlenews.search('CBSE')
    res=googlenews.result()
    # print(res)
    htmllines.append('<div id="cbse">')
    for i in res:
        # print(i)
        title=i['title']
    ...
    googlenews = GoogleNews(lang='en-IN')
    googlenews = GoogleNews(period='d')
    googlenews.search('kuwait')
    res=googlenews.result()
    # print(res)
    htmllines.append('<div id="kuwait">')
    for i in res:
        # print(i)
        title=i['title']
        a=f'''<div class="collumn">
    ...
    googlenews = GoogleNews(lang='en-IN')
    googlenews = GoogleNews(period='d')
    googlenews.search('aviation')
    res=googlenews.result()
    # print(res)
    htmllines.append('<div id="aviation">')
    for i in res:
        # print(i)
        title=i['title']
        a=f'''<div class="collumn">
    ...
    googlenews = GoogleNews(lang='en-IN')
    googlenews = GoogleNews(period='d')
    googlenews.search('entertainment')
    res=googlenews.result()
    # print(res)
    htmllines.append('<div id="entertainment">')
    for i in res:
        # print(i)
        title=i['title']
        a=f'''<div class="collumn">
    ...
    googlenews = GoogleNews(lang='en-IN')
    googlenews = GoogleNews(period='d')
    googlenews.search('aaryan shah')
    res=googlenews.result()
    # print(res)
    htmllines.append('<div id="aaryanshah">')
    for i in res:
        # print(i)
        title=i['title']
        a=f'''<div class="collumn">
    ...
    googlenews = GoogleNews(lang='en-IN')
    googlenews = GoogleNews(period='d')
    googlenews.search('the weeknd')
    res=googlenews.result()
    # print(res)
    htmllines.append('<div id="theweeknd">')
    for i in res:
        # print(i)
        title=i['title']
        a=f'''<div class="collumn">
    ...
    <table id="view-source" style="background-color:black;color:white;">
    <tbody>
    <tr>
    <td class="mdl-data-table__cell--non-numeric" style="color:grey;">JUMP</td>
    </tr>
    <tr>
    <td><a href="#cbse">CBSE</a></td>
    </tr>
    <tr>
    <td><a href="#kuwait">Kuwait</a></td>
    </tr>
    <tr>
    <td><a href="#aviation">Aviation</a></td>
    </tr>
    <tr>
    <td><a href="#entertainment">Entertainment</a></td>
    </tr>
    <tr>
    <td><a href="#aaryanshah">Aaryan Shah</a></td>
    </tr>
    <tr>
    <td><a href="#theweeknd">XO</a></td>
    </tr>
    </tbody>
    </table>
    </body>
